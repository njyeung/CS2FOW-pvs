...
- Tightened the upper eye origin from 24 to 16 units and changed ping preload to a 32-128 unit table: every 25 ms adds 12 units until the 200 ms cap. AABB side/top padding remains 8 units.
